...
![Desktop View](/assets/img/thm/linux/brainpan/brainpan-9999.png)

### Port 10000 (SimpleHTTPServer)

![Desktop View](/assets/img/thm/linux/brainpan/brainpan-10000.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/bin-directory.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/wine.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/41414141.png)

As we can see from the screenshots above, the program tried to access to the address **0x41414141** and crashed. 

![Desktop View](/assets/img/thm/linux/brainpan/wine-error.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/debugger.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/pattern.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/42424242.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/follow-in-dump.png)

All the characters are here (there are no bad characters):

![Desktop View](/assets/img/thm/linux/brainpan/dump.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/ollydbg-search-for.png)

Using `ollydbg`, I found the following address:

![Desktop View](/assets/img/thm/linux/brainpan/JMP_ESP.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/mona-brainpan.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/shell2.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/upgrade-shell.png)

### Inspecting `/home`

![Desktop View](/assets/img/thm/linux/brainpan/checksrv.png)

![Desktop View](/assets/img/thm/linux/brainpan/home.png)

### Upload `Linpeas`

![Desktop View](/assets/img/thm/linux/brainpan/getting_linpeas1.png)

![Desktop View](/assets/img/thm/linux/brainpan/getting_linpeas2.png)

![Desktop View](/assets/img/thm/linux/brainpan/cronjob.png)

![Desktop View](/assets/img/thm/linux/brainpan/sudo_l.png)

![Desktop View](/assets/img/thm/linux/brainpan/anansi_util.png)
...
![Desktop View](/assets/img/thm/linux/brainpan/gtfobins_man.png)

Indeed, it worked, we own root:

![Desktop View](/assets/img/thm/linux/brainpan/privesc_payload.png)

![Desktop View](/assets/img/thm/linux/brainpan/privesc.png)
